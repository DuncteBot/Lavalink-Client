...
public enum LavalinkRegion {
    ...
    ASIA(SYDNEY, VIP_SYDNEY, INDIA, SINGAPORE, VIP_SINGAPORE, JAPAN, VIP_JAPAN, HONG_KONG, SOUTH_AFRICA, VIP_SOUTH_AFRICA),

    EU(LONDON, VIP_LONDON, FRANKFURT, VIP_FRANKFURT, AMSTERDAM, VIP_AMSTERDAM, RUSSIA, EUROPE, EU_CENTRAL, VIP_EU_CENTRAL, EU_WEST, VIP_EU_WEST),
